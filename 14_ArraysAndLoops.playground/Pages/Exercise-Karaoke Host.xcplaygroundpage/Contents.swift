...
songTitles.append("Bohemian Raphsody")
songTitles.append("Crazy Little Thing Called Love")
 ...
 */
songTitles += ["Radio Gaga", "We Are The Champions", "Under Pressure"]
 ...
 */
for songs in songTitles {
    print("\(songs) is up next ")
}
